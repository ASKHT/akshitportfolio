...
function Work({ position, company, location, type, duration }) {
  return (
    <article className="pt-8 border-b-2 border-white-content pb-5 text-white border-opacity-20 dark:border-opacity-20">
      <div className="flex justify-between items-center">
        <h1 className=" md:text-lg lg:text-xl text-white">{position}</h1>
      ...
      <div className="flex justify-between pt-2 ">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className="text-white text-xs md:text-sm font-light pl-1">{company}</p>
          </div>
          <div className="flex items-center">
            <svg
              className="dark:fill-white fill-dark-heading min-w-fit"
              width="16"
              height="12"
              viewBox="0 0 16 12"
              fill="none"
            ...
            <p className="text-white text-xs md:text-sm font-light pl-1">{location}</p>
          </div>
        </div>
        <p className="text-white text-xs md:text-sm font-light pl-1 min-w-fit ">{duration}</p>
      </div>
    </article>
  );
}
